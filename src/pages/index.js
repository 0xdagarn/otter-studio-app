    ...
    <div>
      ...
      <div class="bg-[url('/bg-sura.svg')] bg-contain flex items-center justify-center h-[947px]">
          <div class="max-w-[1200px]">
           <div class="font-normal text-[64px] text-white">Tears of the Antarctic</div>
          <div class="font-normal text-[32px] text-white max-w-[813px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut e</div>
          <div className="flex items-center">
            <div class="bg-[#FFCD4E] rounded-[56px] py-[37px] px-[24px] text-[24px] text-black font-bold"
            onClick={() => alert("clicked!")}>More Details</div>
            ...
            <div class="flex items-center justify-center">
              <Image
                ...
                alt="Picture of the author"
              />
              <div class="font-normal text-[24px] text-white">65 Supporters</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* JH */}
      <div class="bg-black">
      <div class="text-main-orange font-black-han-sans text-3xl font-normal leading-normal align-middle">Funding In Progress</div>
      <div class="flex text-main-orange justify-end text-center gap-[25px] font-noto-sans font-medium leading-normal text-base">
      <div class="rounded-[32px] border border-main-orange "> Ongoing Funding </div> 
      <div class="rounded-[32px] border border-main-orange"> Nature </div> 
      <div class="rounded-[32px] border border-main-orange"> Carbon </div>
      <div class="rounded-[32px] border border-main-orange"> Environmental </div>
      </div>
